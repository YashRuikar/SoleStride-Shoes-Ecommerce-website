...
const popularsales = {
  ...
  items: [
    {
      id: 1, // Updated to a number
      title: "Nike Addapt BB 2.0",
      text: "MEN Running Shoes",
      rating: 4.9,
      btn: "Buy Now",
      img: psale2,
      price: 20000, // Updated to a number
      color: "from-blue-600 to-blue-500",
      shadow: "shadow-lg shadow-blue-500",
    },
    {
      id: 2, // Updated to a number
      title: "Nike Martine Rose",
      text: "MEN Running Shoes",
      rating: 4.5,
      btn: "Buy Now",
      img: psale1,
      price: 21000, // Updated to a number
      color: "from-red-500 to-rose-500",
      shadow: "shadow-lg shadow-rose-500",
    },
    {
      id: 3, // Updated to a number
      title: "Nike Smart Shoe 2.0",
      text: "MEN Running Shoes",
      rating: 4.9,
      btn: "Buy Now",
      img: psale3,
      price: 19000, // Updated to a number
  ...
  items: [
    {
      ...
      btn: "Buy Now",
      img: product7,
      price: 15000, // Updated to a number
    ...
    },
    {
      ...
      btn: "Buy Now",
      img: product2,
      price: 14000, // Updated to a number
